  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-card backdrop-blur-md p-4 flex flex-col justify-between border border-border shadow-inner transition-all hover:border-border group min-w-[240px] flex-1 select-none">
      ...
      <div className="flex items-center justify-center gap-2 my-2 z-10">
        ...
        <span className="font-mono text-xl font-bold text-muted-foreground pb-0.5">:</span>
      ...
      <div className="flex items-center justify-center gap-3 z-10">
        <button
          ...
          className="flex items-center gap-1.5 px-4 py-1.5 rounded-xl bg-primary text-primary-foreground font-semibold text-xs hover:bg-primary/90 active:scale-95 transition-all shadow-md"
        >
        ...
        <button
          onClick={handleReset}
          className="p-1.5 rounded-xl text-muted-foreground hover:text-foreground hover:bg-accent active:scale-90 transition-all"
          title="Reset Timer"
        >
